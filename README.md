<div align="center">
  <img src="./app/public/images/logo-readme.png" alt="FitCrew Logo" width="320"/>
  ...
  <p>
    <a href="https://fitcrew.net" target="_blank">
      <img src="https://img.shields.io/badge/🌐_Ver_ao_vivo-fitcrew.net-22c55e?style=for-the-badge" alt="Ver ao vivo"/>
    </a>
  </p>
</div>
...
FitCrew é uma plataforma PWA de saúde e bem-estar que transforma a experiência de quem treina. Do check-in ao prato de comida, passando pelo treino guiado e pelo acompanhamento de evolução — tudo acontece num único produto, acessível pelo celular como app nativo, sem instalação.
...
Construído offline-first e mobile-first, o FitCrew usa Service Workers para garantir funcionalidade mesmo sem conexão, Web Push VAPID para notificações nativas no celular, e uma arquitetura pensada para escalar. É a experiência de um app premium, entregue direto do navegador.
...
<div align="center">
  <img src="./assets/demo.gif" alt="FitCrew Demo" width="800"/>
  <br/>
  <em>Screenshots e gravações em breve. Acesse <a href="https://fitcrew.net">fitcrew.net</a> para ver ao vivo.</em>
</div>
