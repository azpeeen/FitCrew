/**
 * data.js — Store central em memória do FitCrew
 */
"use strict";
  ...
  const data = [
    {
      ...
      horarios: "Seg-Sex: 6h–23h | Sáb: 8h–20h | Dom: 8h–14h",
    },
    {
      nome: "Bodytech Paulista",
      ...
      site: "https://bodytech.com.br",
      instagram: "https://instagram.com/bodytechbrasil",
      horarios: "Seg-Sex: 6h–22h | Sáb: 8h–18h | Dom: Fechado",
    },
    {
      nome: "BlueFit Copacabana",
      cnpj: "34.567.890/0001-03",
      endereco: "Rua Figueiredo, 88",
      cidade: "Rio de Janeiro",
      cep: "22020050",
      responsavel: "Pedro Costa",
      telefone: "(21) 3456-7892",
      site: "https://bluefit.com.br",
      instagram: "https://instagram.com/bluefitoficial",
      horarios: "Seg-Sex: 5h–23h59 | Sáb: 7h–22h | Dom: 8h–20h",
    },
    {
      nome: "Altinha CrossFit",
      cnpj: "45.678.901/0001-04",
      endereco: "Av. Brasil, 500",
      cidade: "Belo Horizonte",
      cep: "30140000",
      responsavel: "Mariana Souza",
      telefone: "(31) 3456-7893",
      site: "https://altinhacrossfit.com.br",
      instagram: "https://instagram.com/altinhacrossfit",
      horarios: "Seg-Sex: 6h–20h | Sáb: 8h–14h | Dom: Fechado",
    },
    {
      nome: "Espaço Fit Moema",
      cnpj: "56.789.012/0001-05",
      endereco: "Rua Iraí, 211",
      cidade: "São Paulo",
      cep: "04082000",
      responsavel: "Lucas Rocha",
      telefone: "(11) 3456-7894",
      site: "https://espacofitmoema.com.br",
      instagram: "https://instagram.com/espacofitmoema",
      horarios: "Seg-Sex: 6h–22h | Sáb: 8h–18h | Dom: 9h–13h",
    },
    {
      nome: "Academia Prime Curitiba",
      cnpj: "67.890.123/0001-06",
      endereco: "Av. República, 900",
      cidade: "Curitiba",
      cep: "80230000",
      responsavel: "Fernanda Nunes",
      telefone: "(41) 3456-7895",
      site: "https://academiaprime.com.br",
      instagram: "https://instagram.com/academiaprimecwb",
      horarios: "Seg-Sex: 6h–22h | Sáb: 8h–20h | Dom: 8h–14h",
    },
  ];
  data.forEach((a, i) => {
    academias.push({
      ...
      status: "ativa",
      totalAlunos: randomBetween(120, 580),
      createdAt: daysAgo(randomBetween(60, 300)),
    });
  });
}
  ...
  planos.push(
    {
      id: "pl002",
      nome: "FitCrew",
      descricao: "O plano mais popular do FitCrew.",
      preco: 29.9,
      duracao: "mensal",
      beneficios: [
    ...
    },
    {
      ...
      beneficios: [
        "Tudo do FitCrew",
        "Avaliação corporal por foto (IA Vision)",
        "Personal trainer IA exclusivo",
        "Análise avançada de evolução corporal",
        "Suporte prioritário",
      ],
      status: "ativo",
      createdAt: daysAgo(365),
...
function seedUsuarios() {
  ...
  const planosNomes = ["FitCrew", "Black"];
  const precos = [29.9, 59.9];
  // Distribuição: 55% FitCrew, 45% Black
  ...
  nomes.forEach(([nome, sobrenome], i) => {
    ...
    for (let m = 0; m < mesesAtras; m++) {
      const statusTr =
        i < 72 && m === 0 ? "pago" : i >= 72 && m === 0 ? "pendente" : "pago";
...
function seedTickets() {
  const assuntos = [
    ...
    {
      assunto: "Academia sem equipamentos funcionando",
      tipo: "Problema na academia",
    },
  ];
  const statusOpts = [
    "aberto",
  ...
  assuntos.forEach((item, i) => {
    ...
    mensagens.push({
      ...
      ticketId: tid,
      remetente: "usuario",
      texto: `Olá! ${item.assunto}. Podem me ajudar?`,
      criadaEm: hoursAgo(criadoHa),
    });
    if (status === "em_atendimento" || status === "resolvido") {
      mensagens.push({
        ...
        remetente: "admin",
        texto:
          "Olá! Recebemos seu chamado e já estamos verificando o problema.",
        criadaEm: hoursAgo(criadoHa - 1),
      });
    }
    if (status === "resolvido") {
      mensagens.push({
        ...
        ticketId: tid,
        remetente: "admin",
        texto: "Problema resolvido! Por favor, avalie nosso atendimento.",
        criadaEm: hoursAgo(randomBetween(0, 12)),
      });
    }
  });
}
...
function seedNotificacoes() {
  notificacoes.push(
    {
      id: nextId("no"),
      titulo: "Bem-vindo ao FitCrew!",
      mensagem:
        "Sua conta foi criada com sucesso. Explore todas as funcionalidades.",
      tipo: "informativo",
      destinatarios: "todos",
      criadaEm: daysAgo(30),
      lidas: [],
    },
    {
      ...
      mensagem: "Upgrade para o plano Black com 30% de desconto neste mês!",
      tipo: "promocao",
      destinatarios: "pl001",
      criadaEm: daysAgo(5),
      lidas: [],
    },
    {
      ...
      mensagem: "O sistema ficará em manutenção no dia 20/12 entre 02h e 04h.",
      tipo: "alerta",
      destinatarios: "todos",
      criadaEm: daysAgo(2),
      lidas: [],
...
console.log(
  `[data] Seed: ${usuarios.length} usuários | ${academias.length} academias | ${transacoes.length} transações | ${checkins.length} checkins | ${tickets.length} tickets`,
);
