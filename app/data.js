...
function seedPlanos() {
    planos.push(
        { id: 'pl002', nome: 'GymBro',  descricao: 'O plano mais popular do FitCrew.',           preco: 29.90,  duracao: 'mensal', beneficios: ['Treinos manuais + execução com GIFs', 'IA treinadora personalizada', 'Plano de treino gerado por IA', 'Plano de dieta gerado por IA', 'Histórico completo de conversas IA'],                    status: 'ativo', createdAt: daysAgo(365) },
...
function seedNotificacoes() {
    notificacoes.push(
        { id: nextId('no'), titulo: 'Bem-vindo ao FitCrew!',     mensagem: 'Sua conta foi criada com sucesso. Explore todas as funcionalidades.', tipo: 'informativo', destinatarios: 'todos', criadaEm: daysAgo(30), lidas: [] },
